...
public interface CastManager {
    Object cast(CCCondition ccCondition, Object value, Class<?> type) throws CastException;

    class StringCastManager implements CastManager {
        @Override
        public Object cast(CCCondition ccCondition, Object value, Class<?> type) {
    ...
    class ConditionBuilderManager implements CastManager {
        @Override
        public Object cast(CCCondition ccCondition, Object value, Class<?> type) throws CastException {
            if (value instanceof AbstractCondition condition) {
                try {
                    return ConditionBuilder.builder(ccCondition)
                            .condition(condition.getClass().getConstructor(CCCondition.class, Map.class))
